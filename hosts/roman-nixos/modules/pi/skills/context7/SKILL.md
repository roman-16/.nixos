...
1. **Search** for the library: `./scripts/context7.sh search "library-name" "your question"`
2. Pick the best matching library ID from results (e.g., `/facebook/react`)
3. **Fetch docs**: `./scripts/context7.sh docs "/facebook/react" "your specific question"`
