 ...
 * flattens the provider's response into the message, so the OAuth error code is read out of it:
 * every other refresh failure (a timeout, a 500, DNS) is transient and must not cost a credential
 * that still works.
 */
